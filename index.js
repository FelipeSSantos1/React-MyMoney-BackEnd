...
var api = new ParseServer(
{
  ...
  appId      : process.env.APP_ID          || 'tyGfjtYjMW5fEzgOYvYjDIMkvrk9qlPbEWQpq7eI',
  masterKey  : process.env.MASTER_KEY      || 'CTluiSgueB77fIlySg61e9oFz620mn34Ao0Qdsxw', //Add your master key here. Keep it secret!
  ...
  liveQuery:
  {
    classNames: ['BillingCycle'] // List of classes to support for query subscriptions example: [ 'Posts', 'Comments' ]
  },
});
